...
<?php
	...
	$P_id=$_POST["P_id"];
	$P_approval=$_POST["P_approval"];
	//$P_comment=$_POST["P_comment"];
	//$p_id = $_POST["p_id"];
	$result=mysqli_query($db,"UPDATE request_to_sell_product SET P_approval='$P_approval' where P_id= $P_id");
		if($result){
					...
					<?php
						...
						while ($res = mysqli_fetch_array($result))
						{
							...
							<form action="monitoring.php" method = "POST">
								<td><input type="text" name="P_approval" value="<?php echo $res['P_approval']; ?>"/></td>
